...
import { NfcCardsHeroButtons } from "@/components/nfc-cards-hero-buttons"
      ...
      <main className="flex-1">
        <Section className="py-24 md:py-32 bg-surface-hover border-b border-border text-center min-h-[60vh] flex flex-col justify-center">
          <div className="max-w-3xl mx-auto flex flex-col items-center">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6">NFC Cards</h1>
            <p className="text-xl text-muted mb-10 max-w-2xl">
              Premium smart cards powered by NFC technology.
            </p>
            <NfcCardsHeroButtons />
          </div>
        </Section>
